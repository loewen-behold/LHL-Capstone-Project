...
def add_eng_values_pre_predict(X):
    ...
    X['content_completed'] = X['content_completed']*(15/X['week'])
    X['quiz_completed'] = X['quiz_completed']*(15/X['week'])
    X['total_quiz_attempts'] = X['total_quiz_attempts']*(15/X['week'])
    X['discussion_post_read'] = X['discussion_post_read']*(15/X['week'])
    X['total_time_spent_in_content'] = X['total_time_spent_in_content']*(15/X['week'])
    ...
    X['number_of_logins_to_the_system'] = X['logins_per_course']*X['total_course_count']
